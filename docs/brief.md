...
Build a clean, fast, and reviewable website for the HeLiCorp IT Website Internship round 2 assessment.

The site presents PETKIT Pura Max 2 as the primary product and connects it with a small Smart Cat Care ecosystem:
...
- Basic SEO metadata and Open Graph metadata
- Public GitHub repository
- Vercel production deployment
- PageSpeed evidence from the deployed URL

## Planned Enhancements

Enhancements are scoped after the core landing page is stable:
...
Product copy uses benefit-led wording while commercial details such as local warranty, shipping, exact Vietnam SKU, and some model naming are treated as items to verify before commercial publication.
